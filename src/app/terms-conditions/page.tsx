...
export default function Page() {
	return (
		<div className="p-6 md:py-10 max-w-[900px] mx-auto">
			<H1>
				Dummy Terms and Conditions for Company Name Introduction These
				Website
			</H1>
			<p>
				Standard Terms and Conditions written on this webpage shall
				manage your use of our website, Webiste Name accessible at
				Website.com. These Terms will be applied fully and affect to
				your use of this Website. By using this Website, you agreed to
				accept all terms and conditions written in here. You must not
				use this Website if you disagree with any of these Website
				Standard Terms and Conditions. Minors or people below 18 years
			...
			<H1 className="lg:text-3xl text-xl">Restrictions</H1>
			...
			<H1 className="lg:text-3xl text-xl">No warranties</H1>
			...
			<H1 className="lg:text-3xl text-xl">Limitation of liability</H1>
			...
			<H1 className="lg:text-4xl text-2xl">Indemnification
			</H1>
